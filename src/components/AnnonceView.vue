        ...
        <div class="container">
          <div class="row">
            <div class="col-lg-8 offset-lg-2 header-text">
              <h2 style="color: green;">RETROUVEZ TOUTES LES MEILLEURS ANNONCES DU MOMENT SUR FREELOST</h2>
...
<div class="banniere_horizontale" width="70px" height="50px" ></div> 
       ...
       <div class="contenair">
  <div class="row p-5  ">
    <h5 style="color: green;">- ANNONCES -</h5>
    <p>{{objects}}</p>
      <div class="col-8 p-0 ">
        <!-- CARD -->
        <div class="col-4 d-inline-flex"><!-- v-for -->
            <div class="card mt-3">
                
                <!-- header de la publication -->
                                <div class="d-flex justify-content-between p-2 px-3">
                                  <div class="d-flex flex-row align-items-center"> <img src="https://ichef.bbci.co.uk/news/640/cpsprodpb/14417/production/_108376928_01ajaranchout.jpg" width="50" class="rounded-circle ">
                                      <div class="d-flex flex-column ml-2 px-2"> <span class="font-weight-bold ">CentreDeCollecte</span> <small class="text-primary">Categorie</small> </div>
                                  </div>
                                  <div class="d-flex flex-row mt-1 ellipsis"> <small class="mr-3">20 mins</small> </div>
                                </div>
               <!----------------------------------------->

                <img src="https://images.pexels.com/photos/1149831/pexels-photo-1149831.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940" class="card-img-top" alt="...">
                        <div class="card-body">
...
<!-- fin card -->
<!-- CARD -->
        <div class="col-4 d-inline-flex ml-2" ><!-- v-for -->
            <div class="card mt-3">
...
import axios from 'axios'
    ...
    export default {
        ...
        mounted(){
         axios.get('https://freelost-api.kouelab.com/Objects').then(response => (this.objects = response.data)) 
